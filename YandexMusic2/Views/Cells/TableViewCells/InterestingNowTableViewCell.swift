...
class InterestingNowTableViewCell: UITableViewCell {
    ...
    private let types = [
        "Плейлист", "Плейлист", "Видеоклипы", "Альбом", "Плейлист", "Альбом", "Плейлист"
    ]
    
    private let titles = [
        "Новые танцевальные хиты", "100 суперхитов", "Новинки клипов", "«Три дня дождя» о жизни сквозь бессилие", "Громкие новинки: рок", "Zivert переизобретает себя", "В сердечке"
    ]
    
    private let descriptions = [
        "Килджо, Oniel, Punkshow и другие", "Лучшие песни за последние несколько лет", "Мари Краймбрери, Люся Чеботина, aikko и другие", "Неприглядный анализ отношений и самого себя", "тринадцать карат и мина, Лали, TRITIA и другие", "Неожиданные эксперименты на новой пластинке", "Самые залайканные треки за всю историю Музыки"
    ]
