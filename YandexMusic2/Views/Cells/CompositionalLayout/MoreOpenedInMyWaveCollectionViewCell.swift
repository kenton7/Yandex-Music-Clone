//
//  MoreOpenedInMyWaveCollectionViewCell.swift
//  YandexMusic2
//
...
class MoreOpenedInMyWaveCollectionViewCell: UICollectionViewCell {
    
    static let cellID = "MoreOpenedInMyWaveCollectionViewCell"
